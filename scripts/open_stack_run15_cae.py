"""Abaqus CAE GUI startup script: open the run15 chimney-collapse ODB and show
the deformed last frame from a side view, for interactive inspection.

Runs inside a CAE GUI session (no noGUI flag):
    abq2026.bat cae script=scripts/open_stack_run15_cae.py
...
ODB_PATH = r"D:\GitHub Dev\Demolition-Simulator\abaqus_projects\concrete_stack\results\stack_job_run.odb"
