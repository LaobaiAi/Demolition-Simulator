"""Abaqus CAE GUI startup script: open the run9 chimney-collapse ODB and show
the deformed last frame from a side view, for interactive inspection.

Runs inside a CAE GUI session (no noGUI flag):
    abq2026.bat cae script=scripts/open_stack_cae.py
...
ODB_PATH = r"D:\GitHub Dev\Demolition-Simulator\abaqus_projects\concrete_stack_run32\results\stack_job_run.odb"
...
def _jump_last_frame(vp, step_names, step):
    last_idx = 13  # t=7.8s, tip down 99.9m = ground-contact instant (run 32 metrics f=13)
